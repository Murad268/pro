...
<div class="limiter">
   <div class="container-login100" style="background-image: url('images/bg-01.jpg')">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
         <form action="{{route('front.auth.sign_in')}}" method="post" class="login100-form validate-form">
            @csrf
            ...
            <div class="wrap-input100 validate-input">
               ...
               <input class="input100" type="password" name="passwordRepeat" placeholder="Type your password" />
